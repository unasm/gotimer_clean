...
func (p *ControllerRegister) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	//fmt.Println("in_the_init", context.ResponseWriter.Header().Get("Content-Type"))
...
func (p *ControllerRegister) recoverPanic(context *beecontext.Context) {
	if err := recover(); err != nil {
		...
		fmt.Println("start_recoverPanic")
		...
		fmt.Println("start_recoverPanic_res")
		//context.ResponseWriter.Header().Set("Content-Type", "application/json; charset=utf-8")
		context.Output.Header("Content-Type", "application/json; charset=utf-8")
		if BConfig.RunMode == DEV {
			showErrJson(err, context, stack)
		} else {
			showErrJson(err, context, stack)
		}
	}
